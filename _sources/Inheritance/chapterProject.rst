    ...
    * ``.getMove(category, obscuredPhrase, guessed)``: Should return a valid move.
    ...
    class MyTests(TestCaseGui):
        ...
        def testPartC(self):
            ...
            self.assertEqual(player.prizeMoney, 0, "Testing that the prizeMoney was correctly set")
            self.assertEqual(player.prizes, [], "Testing that the prizes was correctly set")
            self.assertEqual(player.SORTED_FREQUENCIES, 'ZQXJKVBPYGFWMUCLDRHSNIOATE', "Testing that WOFComputerPlayer.SORTED_FREQUENCIES was correctly set")
            self.assertEqual(WOFComputerPlayer.SORTED_FREQUENCIES, 'ZQXJKVBPYGFWMUCLDRHSNIOATE', "Testing that WOFComputerPlayer.SORTED_FREQUENCIES was set as a class variable")
            ...
            if anyInvalidGuesses:
                self.assertFalse(anyInvalidGuesses, "Made an invalid move ({} when guessed was {})".format(move, ','.join(guessed)))
